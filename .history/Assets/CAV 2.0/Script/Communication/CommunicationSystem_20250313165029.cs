    ...
    public class RoadSegment
    {
        ...
        public void AddVehicle(int vehicleId)
        {
            if (!vehicles.Contains(vehicleId))
            {
                ...
                vehicleData.Add(new vData{vehicleId=vehicleId, speed=0, time=0});
                trafficDensity++;
            }
        }
        ...
        public void updateAvgTime(int time){
            int sum=0;
            int count=0;
            foreach (int vehicle in vehicles)
            {
                
             //ask for segment time spent by vehicle
            //  increment count   
            }
            avgTime=sum/count;
        }
        ...
        public void ReceiveInformation(string message, int senderId)
        {
            ...
            if(message=="Entering segment"){
                AddVehicle(senderId);
            }else if(message=="Exiting segment"){
