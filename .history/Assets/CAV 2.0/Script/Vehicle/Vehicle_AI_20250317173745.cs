    ...
    void SetWaypointVehicleIsOn()
        {
            ...
            foreach (Segment segment in trafficSystem.segments)
            {
                if (segment.IsOnSegment(this.transform.position))
                {
                    ...
                    {
                        Debug.LogWarning("searching for waypoint");
                        ...
                        if (d < minDist && lSpace.z > 0)
                        {
                            ...
                            s+="Start segment: "+currentTarget.segment+" Start waypoint: "+currentTarget.waypoint+" Next segment: "+NavigationComponent.GetNextSegmentId();
                            Debug.LogWarning(s);
