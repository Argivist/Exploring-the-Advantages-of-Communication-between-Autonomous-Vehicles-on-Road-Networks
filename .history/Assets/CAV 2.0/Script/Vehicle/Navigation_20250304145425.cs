...
public int GetNextSegmentId(){
            if(trafficSystem.segments[Vehicle_AI.currentTarget.segment].nextSegments.Count == 0)
                return 0;
            int c = Random.Range(0, trafficSystem.segments[Vehicle_AI.currentTarget.segment].nextSegments.Count);//segment selection
            return trafficSystem.segments[Vehicle_AI.currentTarget.segment].nextSegments[c].id;
