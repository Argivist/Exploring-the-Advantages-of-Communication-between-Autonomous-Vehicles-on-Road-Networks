...
public int limit=1000;
    ...
    {
        return (NumSpawnedVehicles >= sc.vehicleList.Count && NumDestroyedVehicles >= SimConfig.vehicleList.Count);//|| nextSim;
    }
    ...
    private void ResetSimulationState()
    {
        ...
        tempList = new List<SimConfig.Vehicle>(sc.vehicleList);
