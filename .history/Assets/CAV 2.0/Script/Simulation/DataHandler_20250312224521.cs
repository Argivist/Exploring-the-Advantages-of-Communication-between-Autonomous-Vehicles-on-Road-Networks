...
public class DataHandler : MonoBehaviour
{
    ...
    public void ProcessData()
    {
        ...
        List<string[]> data = new List<string[]>();
        data.Add(new string[] { "ID", "Start Position X","Start Position Y","Start Position Z", "End Position X","End Position Y","End Position Z", "Type", "Time Spent_Norm","Time Spent_CAV","Time Spent_Mixed", "Simulation" });
