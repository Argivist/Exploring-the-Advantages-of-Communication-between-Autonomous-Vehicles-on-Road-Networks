    ...
    {   
        ...
        void Update(){
            ...
            if(intersectionType == IntersectionType.STOP){
                for(int d = 0; d < vehiclesInIntersection.Count; d++){
                    if(vehiclesInIntersection[d] == null){
                        ExitStop(vehiclesInIntersection[d]);
                        vehiclesInIntersection.Remove(vehiclesInIntersection[d]);
                    }
